...
# result = evaluate_ad_poster(image_url, scoring_criteria)

# if result:
#     print("Extracted Scoring Data:")
#     print(json.dumps(result, indent=4))
# else:
#     print("Failed to evaluate the ad poster.")
...
def generate_creative():
    ...
    try:
        ...
        color_description = ", ".join([f"{name}" for name in brand_palette])
        prompt = f"""
